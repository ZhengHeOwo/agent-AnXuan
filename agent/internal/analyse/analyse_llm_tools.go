...
var preferencesOperationSubmitToolParameters = json.RawMessage(`{
  ...
  "properties": {
    ...
    "value": {
      "type": "string",
      "minLength": 1,
      "description": "仅 update 操作必填，其他操作应省略。此字符串将作为记录的完整 Content 保存，并作为 description 提供给主模型，表示助手自身应采用的工作倾向，而不是用户档案或证据报告。使用简洁、明确、可执行的简体中文，保留领域、适用条件、项目阶段及授权边界；中置信度倾向须采用有条件的表述。更新时整合仍然有效的旧内容，不只提供新增片段。不要写入置信度元数据、原始对话或凭证，也不要把相互矛盾的要求无条件拼接。"
    },
    "reason": {
      "type": "string",
      "minLength": 1,
